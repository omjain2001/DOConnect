...
export default function App({ navigation }) {
  ...
  const [degree] = React.useState("");
  const [bio, setbio] = React.useState("");
  const [secialization, setsecialization] = React.useState("");
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Text style={{ fontSize: 18, marginTop: 15 }}>Doctor name</Text>
      </View>
      <View
        style={{
      ...
      >
        <ScrollView style={{ flex: 1 }}>
          <SafeAreaView>
            ...
            >
              <FontAwesome5
                style={{ padding: 10, marginRight: -50, color: "#0CA789" }}
                name="user-edit"
                size={24}
                color="black"
              />
            ...
            >
              ...
              <TextInput
                ...
                onChangeText={(text) => setsecialization(text)}
                value={secialization}
